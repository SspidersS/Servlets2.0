...
public class TimeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss z").withZone(ZoneId.of(timezone));
    ...
    private String getValidTimezone(String timezoneParam, HttpServletRequest request, HttpServletResponse response) {
        if (timezoneParam != null && !timezoneParam.isEmpty()) {
            try {
                ...
                saveCookie(response, timezoneParam);
    ...
    private void saveCookie(HttpServletResponse response, String timezone) {
